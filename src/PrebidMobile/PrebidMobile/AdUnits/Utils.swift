...
public class Utils : NSObject {
    ...
    /// An adapter for Adform Advertising SDK integrations.
    private var adformAdapter = AdformAdapter()
    ...
    @objc public func removeHBKeywords (adObject:AnyObject) {
        ...
        if adformAdapter.removeHBKeywords(from: adObject, with: adServerObject) {
            return
        }
    }
    ...
    @objc func validateAndAttachKeywords (adObject:AnyObject, bidResponse:BidResponse) {
        ...
        if adformAdapter.validateAndAttachKeywords(to: adObject, with: adServerObject, from: bidResponse) {
            return
        }
